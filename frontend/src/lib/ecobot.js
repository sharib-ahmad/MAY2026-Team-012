...
export const ECOBOT_TOPICS = [
  ...
  },
  {
    ...
    reply: 'Flatten cardboard boxes and keep paper dry — wet paper is usually rejected at the recycling facility.',
  },
  {
    keywords: ['metal', 'can', 'tin'],
    reply: 'A quick rinse on metal cans and tins before collection keeps the whole batch cleaner and easier to recycle.',
  },
  {
    keywords: ['pickup', 'schedule', 'collect'],
    reply: 'You can schedule a pickup any time from the Schedule Pickup tab — pick a category, date, and time slot that works for you.',
  },
  {
    keywords: ['credit', 'reward', 'point'],
    reply: 'Credits build up automatically for every collected pickup — check the Impact tab to see your running balance and badges.',
  },
  {
    keywords: ['donate', 'donation', 'marketplace'],
    reply: 'Got something still usable? List it on the Marketplace tab instead of throwing it out — other residents nearby can claim it.',
  },
  {
  ...
  },
  {
    ...
    reply: 'Head to My Pickups, open a pickup, and tap "Track Live Pickup" to see how many stops are left before yours.',
  },
  {
    keywords: ['compost', 'organic', 'wet waste', 'kitchen waste'],
    reply: 'Wet/organic waste is best composted at home if you can — it keeps the smelliest waste out of collection bags entirely.',
  },
  {
    keywords: ['co2', 'carbon', 'environment', 'impact'],
    reply: 'Every kilogram you divert from landfill saves roughly 1.3kg of CO₂ — your running total is on the Impact tab.',
  },
];
