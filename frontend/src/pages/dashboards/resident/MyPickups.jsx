          ...
          <div className="space-y-3 text-sm">
            ...
            {selected.collector_name ? (
              <div className="bg-primary/5 rounded-input p-3">
                ...
                {selected.collector_phone && (
                  <p className="text-gray-500">{selected.collector_phone}</p>
                )}
            ...
            {confirmingCancel && (
              <div className="border border-red-200 bg-red-50 rounded-input p-3 space-y-3">
                <div className="flex gap-2 text-red-700">
                  ...
                  <p className="text-sm">
                    Cancel pickup <span className="font-medium">{selected.ref_code}</span>? This
                    can't be undone, and you'll need to schedule a new pickup if you change your
                    mind.
                  </p>
                </div>
        ...
        {selected && showTracking && tracking && (
          <div className="space-y-4 text-sm">
            <p className="text-xs text-gray-400">
              Live status for <span className="font-medium text-gray-600">{tracking.ref_code}</span>{" "}
              only.
            </p>
